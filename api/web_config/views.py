...
from .serializers import SocialMediaSerializer, LandingPageConfigSerializer
...
class LandingPageConfigViewSet(viewsets.ModelViewSet):
    """
    ViewSet to manage Landing Page configuration.
    It ensures we are always working with the single instance of configuration.
    """
    ...
    def get_object(self):
        # Always return the first instance, create if doesn't exist
        obj, created = LandingPageConfig.objects.get_or_create(pk=1)
        return obj
